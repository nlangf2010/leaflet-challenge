// I worked with Erin Wills TA along with: Cory Ptacek, Naomi Scully, Paule Nguendang, and Justin Forkert
// Overview
...
function circleSize(feature) {
    ...
    L.geoJSON(data, {
      ...
      pointToLayer: function(feature, latlng) {
        return new L.CircleMarker(latlng, {
          radius: circleSize(feature), //10, //radius(magnitude)
          fillOpacity: 0.85 
        });
      }
    }).addTo(earthquakes);
  ...
  legend.onAdd = function (map) {
      ...
      var div = L.DomUtil.create('div', 'info legend'),     //<div class = "info legend">loop1, loop2, loop3 <div>
          grades = [-10, 10, 30, 50, 70, 90],
          labels = ["green", "chartreuse", "yellow", "orange", "salmon", "red"];  //what are labels
      div.innerHTML += "<h3>Earthquake Depth (mi)</h3><hr>"
